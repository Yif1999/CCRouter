...
<head>
    ...
    <title>Terms of Service - CCRouter</title>
...
<body>
    <div class="container">
        ...
        <p>CCRouter is an API translation service that converts requests between Anthropic's Claude API format and OpenAI-compatible API formats. The service acts as a proxy to enable compatibility between different API standards.</p>

        <h2>2. Acceptance of Terms</h2>
        <p>By accessing or using CCRouter, you agree to be bound by these Terms of Service. If you do not agree to these terms, you must not use the service.</p>
        ...
        <ul>
            <li>CCRouter is provided "as is" without warranties of any kind</li>
        ...
        <ul>
            <li>CCRouter processes requests in real-time and does not intentionally store user data</li>
        ...
        <p>CCRouter, its operators, and contributors shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use the service, including but not limited to:</p>
        <ul>
        ...
        <p>You agree to indemnify and hold harmless CCRouter and its operators from any claims, damages, or expenses arising from your use of the service or violation of these terms.</p>

        <h2>8. Third-Party Services</h2>
        <p>CCRouter integrates with third-party API services. Your use of these services through CCRouter is subject to their respective terms of service and privacy policies. We are not responsible for the actions, policies, or content of third-party services.</p>

        <h2>9. Intellectual Property</h2>
        <p>CCRouter is open-source software. All trademarks, service marks, and logos used in connection with third-party services are the property of their respective owners.</p>
        ...
        <div class="contact">
            ...
            <p>For questions about these Terms of Service, please contact us through the <a href="https://github.com/luohy15/CCRouter" target="_blank">GitHub repository</a>.</p>
        </div>
