...
<head>
    ...
    <title>Privacy Policy - CCRouter</title>
...
<body>
    <div class="container">
        ...
        <div class="highlight">
            <strong>Privacy First:</strong> CCRouter is designed to be a transparent proxy that does not store your data. However, your requests are processed by third-party API providers with their own privacy policies.
        </div>
        ...
        <div class="data-flow">
            ...
            <ol>
                <li><strong>Your Application</strong> → sends request to CCRouter</li>
                <li><strong>CCRouter</strong> → converts format and forwards to API provider (e.g., OpenRouter)</li>
                <li><strong>API Provider</strong> → processes request and returns response</li>
                <li><strong>CCRouter</strong> → converts response format and returns to you</li>
            </ol>
            <p><em>CCRouter acts as a pass-through service and does not retain data.</em></p>
        </div>

        <h2>3. Third-Party Services</h2>
        <p>When you use CCRouter, your data is processed by third-party API providers. These services have their own privacy policies:</p>
        <ul>
        ...
        <div class="warning">
            <strong>Important:</strong> CCRouter cannot control how third-party API providers handle your data. Please review their privacy policies carefully.
        </div>

        <h2>4. Technical Implementation</h2>
        
        <h3>4.1 Cloudflare Workers</h3>
        <p>CCRouter runs on Cloudflare Workers, which may temporarily process requests in memory during execution. Cloudflare's privacy practices apply to the infrastructure layer.</p>

        <h3>4.2 No Persistent Storage</h3>
        <p>CCRouter does not use databases or persistent storage for user data. All processing happens in real-time during request handling.</p>
        ...
        <p>For maximum privacy control, you can deploy CCRouter yourself:</p>
        <ul>
        ...
        <p>CCRouter may process data in various geographic locations through Cloudflare's global network. Third-party API providers may also process data internationally according to their own policies.</p>

        <h2>8. Children's Privacy</h2>
        <p>CCRouter is not intended for use by children under 13 years of age. We do not knowingly collect or process information from children.</p>
        ...
        <p>CCRouter is designed with privacy-by-design principles:</p>
        <ul>
        ...
        <div class="contact">
            ...
            <ul>
                <li>GitHub Issues: <a href="https://github.com/luohy15/CCRouter/issues" target="_blank">Report privacy concerns</a></li>
                <li>General inquiries: Through GitHub repository</li>
            </ul>
            <p><strong>Data Subject Requests:</strong> Since CCRouter does not store personal data, most data subject requests should be directed to the relevant third-party API providers.</p>
        </div>

        <div class="footer">
            <p>CCRouter is an independent, open-source project.<br>
